...
**狀態**: v1.0 通用模板 (2026-05-28 abstraction sweep,per spec `docs/2026-05-28-idiomatic-rust-plan-abstraction-design.md`)。原 v0.7 nrg-prototype hard-coded 已抽象化為 placeholder + illustrative example 雙層結構;v0.8 暫存 12 條心得全數落地 (9 條 plan 內 → Task 2.1 sub-section;3 條 plan 外 → adlink-can `CLAUDE.md`;見 §v0.8 落地紀錄)。
